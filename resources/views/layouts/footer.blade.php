    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <ul class="icon">
                    <li><a><i style="margin-top:10px" class="fab fa-facebook-f"></i></a></li>
                    <li><a><i style="margin-top:10px" class="fab fa-twitter"></i></a></li>
                    <li><a><i style="margin-top:10px" class="fab fa-instagram"></i></a></li>
                    <li><a><i style="margin-top:10px" class="fab fa-dribbble"></i></a></li>
                </ul>
            </div>
